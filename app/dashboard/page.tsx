            ...
            <>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8 mb-10 transition-all duration-300 hover:shadow-md">
                <div className="text-center">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Your Personalized Credit Card Insights</h2>
                  <p className="text-gray-600 mb-6">Based on your spending patterns, we've identified opportunities to save money and earn more rewards.</p>
                  <Link 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                  ...
                  <div className="flex items-center mb-4">
                    <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                      <svg className="w-5 h-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-2 shadow">
                        <svg className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2h-2a2 2 0 00-2-2z" />
                        </svg>
                      </div>
                ...
                <div className="border border-gray-200 rounded-xl p-6 transition-all duration-300 hover:shadow-md hover:border-blue-300">
                  <div className="flex items-center mb-4">
                    <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                      <svg className="w-5 h-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                      </svg>
                    </div>
